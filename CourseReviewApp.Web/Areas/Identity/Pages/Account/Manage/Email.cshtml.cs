...
namespace CourseReviewApp.Web.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public EmailModel(
            UserManager<AppUser> userManager, IEmailSenderService emailSenderService, IFileService fileTool)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                string body = await _fileService.LoadMessageHtml("change_email.html");
