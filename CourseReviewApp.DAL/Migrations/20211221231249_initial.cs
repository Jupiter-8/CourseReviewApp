    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HelpfullReviews", x => new { x.UserId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_HelpfullReviews_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HelpfullReviews_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnerComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OwnerComments_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OwnerComments_Reviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "Reviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewReports_AspNetUsers_ReportingUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpfullReviews_ReviewId",
                table: "HelpfullReviews",
                column: "ReviewId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnerComments_ReviewId",
                table: "OwnerComments",
                column: "ReviewId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReviewReports_ReportingUserId",
                table: "ReviewReports",
